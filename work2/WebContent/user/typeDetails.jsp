...
<body class="nav-header">
	...
	<%-- <div class="panel panel-primary" style="padding-top:50px;"> 
		...
		<div class="container">
			<div style="text-align:center;letter-spacing:2px;margin-top:20px;">
				<h3>活动名称：${type.tname}</h3>
			</div>
			<div style="text-align:left;letter-spacing:2px;margin-top:20px;">
				<h5>活动内容：${type.tcontent}</h5>
				<h5>开始时间：${type.startdate}</h5>
				<h5>结束时间：${type.enddate}</h5>
			</div>
		</div>
		<br />
	</div>
 --%>
	<section class="met-content animsition">
			...
			<div style="text-align:left;letter-spacing:2px;margin-top:20px;">
				<h5>活动内容：${type.tcontent}</h5>
				<h5 style="text-align:right">开始时间：${type.startdate}</h5>
				<h5 style="text-align:right">结束时间：${type.enddate}</h5>
			</div>
                                </li>
