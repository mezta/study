	 ...
	 <section class="met-content animsition">
            <div class="container">
                <div class="row">
                        ...
                        <div class="met-news-list news-lists">
                            ...
                            <ul class="met-page-ajax" data-scale=''>
                             <c:forEach items="${shopList}" var="val" varStatus="vs">
                                <li>
                                      <a class="img" href="${basePath}shop/userGetShopById?shopid=${val.shopid}">
                                        <img src="${basePath}${val.pic}" style="width:150px;height:170px;">
                                    </a>
                                    <h4>
                                    ...
                                    <p class="info">
                                       <!--  <span>
                                        ...
                                        <span>
                                            ...
                                            商品价格：<span style="color: red;">${val.price}
                                        </span>&nbsp;&nbsp;&nbsp;<span>
                                            <i class="fa fa-pencil-square">
                                            </i>
                                                      商品所需积分：<span style="color: red;">${val.letter} 
                                 ...
                                 <%--  <p class="more">
                                        <a href="${basePath}shop/userGetShopById?shopid=${val.shopid}&uid=${userMain.uid}"​ title="" >
                                            购买>>
                                        </a>
                                    </p>  --%>
					...
					<c:if test="${userMain.uname == null}">
							<p class="more">
                                        <a href="${basePath}shop/userGetShopId?shopid=${val.shopid}"​ title="" >
                                            购买>>
                                        </a>
                                    </p> 
                	</c:if>
...
<script type="text/javascript">
				...
				$("#search").click(function(){
					...
					var url="../shop/getAllShop?currPage=1&IName="+data;
				...
				function goNewPage(pageNum){
					...
					var data='${IName}';
					window.location.href="../shop/getAllShop?currPage="+pageNum+"&IName="+data;
				}
