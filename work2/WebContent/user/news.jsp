...
<body class="nav-header">
	...
	<h3 align="center">最新公告</h3>
		...
		<div class="container">
			...
			<div class="row">
				<c:forEach items="${news}" var="val" varStatus="vs">
                             ...
                             <c:forEach items="${newsList}" var="val" varStatus="vs">
                                <li>
                                 ...
                                 <!--   
                                  ...
                                  <p class="more">
                                        <a href="${basePath}news/userGetNewsById?nid=${val.nid}" title=""
                                       >
                                            查看更多>>
                                        </a>
                                    </p>
...
<script type="text/javascript">
				...
				$("#search").click(function(){
					...
					var url="../news/getAllNews?currPage=1&IName="+data;
				...
				function goNewPage(pageNum){
					...
					var data='${IName}';
					window.location.href="../news/getAllNews?currPage="+pageNum+"&IName="+data;
				}
