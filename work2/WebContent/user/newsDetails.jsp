                            ...
                            <div class="container">
                                <div class="row">
                                    <ol class="breadcrumb">
                                        ...
                                        >
                                        <a href='${basePath}news/getAllNews?currPage=1'>
                                           最新公告
                                        </a>
                                        >
                                    </ol>
                        ...
                        <div class="met-news-list news-lists">
                            ...
                            <ul class="met-page-ajax" data-scale=''>
                                <li>
                                   ...
                                   <div style="text-align:center;letter-spacing:2px;margin-top:20px;">
				<h3>${news.title}</h3>
				   <span style="font-size:16.0pt;font-family:仿宋_GB2312;">${news.content}</span>
			</div>
                   <h5 style="text-align:right">发布时间：${news.startdate}</h5>             
                                </li>
                    ...
                    <div class="col-md-3 met-conx">
                       ...
                       <ul>
                            <c:forEach items="${newss}" begin="0" end="2" var="val" varStatus="vs">
