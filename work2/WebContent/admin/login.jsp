	...
	<div class="sub-main-w3">
		<form action="adminlogin" method="post" > 
			<div class="form-style-agile">
				...
				<input placeholder="Username"  id="aname" name="aname"  type="text" required="">
			</div>
			<div class="form-style-agile">
				<label>
					密码
				...
				<input placeholder="Password" id="apass" name="apass" type="password" required="">
			</div>
			<div class="form-style-agile">
				<label>
					验证码
		 ...
		 <canvas id="canvas" width="120" height="50"></canvas>
			...
			<div class="wthree-text">
				<ul>
					<li>
							<a href="${basePath}user/login.jsp"><button type="button" class="btn btn-danger">用户登录</button></a>
						<!-- //checkout -->
					</li>
					<li>
